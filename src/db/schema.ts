...
export const users = pgTable("users", {
  ...
  bulletRating: integer("bullet_rating").notNull().default(1500),
  blitzRating: integer("blitz_rating").notNull().default(1500),
  rapidRating: integer("rapid_rating").notNull().default(1500),
  classicalRating: integer("classical_rating").notNull().default(1500),
